...
# Download the standalone build directly from GitHub
echo "Downloading standalone frontend build..."
cd /tmp
rm -rf frontend-standalone.tar.gz
wget --header="Authorization: token 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" \
  -O frontend-standalone.tar.gz \
  "https://github.com/rickdphx/SignatureSystems/raw/claude/setup-signature-chair-booking-RX9Gg/frontend-standalone.tar.gz"
echo "✓ Downloaded"
echo ""
